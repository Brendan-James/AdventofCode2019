...
def intcode(data,inqueue = []):
	...
	while pc in data:
		...
		if opcode == 1:
			...
			if ic>=len(inqueue):
				inqueue.extend(asciiencode(input()+"\n"))
...
intcode(copy.deepcopy(data))

# gained access while holding
# fuel cell
# astrolabe
# ornament
# hologram 

# to find answer the 1073874948

# https://docs.google.com/spreadsheets/d/11ZKxUbUopC_0TtFYRRCnCZI-v5avB74oPxLG93Qflag/edit?usp=sharing
